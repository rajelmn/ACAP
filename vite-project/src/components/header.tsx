...
export default function Header({ setLang, showLang }: {
    setLang: (
    ...
    return (
        ...
        <>
            ...
            <header className={`p-4  z-50 bg-white flex items-center justify-between w-screen ${i18next.language === "ar" ? "arabic-lang" : ""}`}>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <HashLink smooth to="/#donation">

                    <button
        // onClick={handleCheck}
        className={`px-5 py-2.5 hidden md:flex ${i18n.language === "ar" ? "flex-row-reverse items-center" : ""}  bg-[#FDB71D] text-white 
